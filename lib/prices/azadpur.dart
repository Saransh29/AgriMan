...
class Azadpur extends StatefulWidget {
  ...
  @override
  _AzadpurState createState() => _AzadpurState();
}

class _AzadpurState extends State<Azadpur> {
  @override
  ...
  Future<List<Product>> generateProductList() async {
    var response = await http.get(Uri.parse(
        'https://test123-7b3b5-default-rtdb.asia-southeast1.firebasedatabase.app/Azadpur.json'));
    var decodedProducts =
