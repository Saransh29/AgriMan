...
class Najafgarh extends StatefulWidget {

  @override
  _NajafgarhState createState() => _NajafgarhState();
}

class _NajafgarhState extends State<Najafgarh> {
  @override
  ...
  Future<List<Product>> generateProductList() async {
    var response = await http.get(Uri.parse(
        'https://test123-7b3b5-default-rtdb.asia-southeast1.firebasedatabase.app/Najafgarh.json'));
    var decodedProducts =
