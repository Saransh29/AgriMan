...
class Panipat extends StatefulWidget {
  ...
  @override
  _PanipatState createState() => _PanipatState();
}

class _PanipatState extends State<Panipat> {
  @override
  ...
  Future<List<Product>> generateProductList() async {
    var response = await http.get(Uri.parse(
        'https://test123-7b3b5-default-rtdb.asia-southeast1.firebasedatabase.app/Panipat.json'));
    var decodedProducts =
