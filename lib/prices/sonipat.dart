...
class Sonipat extends StatefulWidget {
  ...
  @override
  _SonipatState createState() => _SonipatState();
}

class _SonipatState extends State<Sonipat> {
  @override
  ...
  Future<List<Product>> generateProductList() async {
    var response = await http.get(Uri.parse(
        'https://test123-7b3b5-default-rtdb.asia-southeast1.firebasedatabase.app/Sonipat.json'));
    var decodedProducts =
